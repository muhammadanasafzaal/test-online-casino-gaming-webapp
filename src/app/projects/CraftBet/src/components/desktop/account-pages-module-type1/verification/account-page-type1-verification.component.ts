...
@Component({
  selector: 'app-account-page-type1-verification',
  templateUrl: './account-page-type1-verification.component.html',
})
export class AccountPageType1VerificationComponent extends CommonSettingsComponent {
