...
@Component({
  selector: 'app-account-page-type1-open-tickets',
  templateUrl: './account-page-type1-open-tickets.component.html'
})
export class AccountPageType1OpenTicketsComponent extends AppCommonOpenTicketComponent {
