...
@Component({
  selector: 'app-account-page-type2-settings',
  templateUrl: './account-page-type2-settings.component.html',
})
export class AccountPageType2SettingsComponent extends CommonSettingsComponent {
