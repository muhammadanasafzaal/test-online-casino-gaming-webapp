...
@Component({
    selector: 'app-account-page-type3-verification',
    templateUrl: './account-page-type3-verification.component.html',
    styleUrls: ['./account-page-type3-verification.component.scss']
})
export class AccountPageType3VerificationComponent implements OnInit, AfterViewInit {
