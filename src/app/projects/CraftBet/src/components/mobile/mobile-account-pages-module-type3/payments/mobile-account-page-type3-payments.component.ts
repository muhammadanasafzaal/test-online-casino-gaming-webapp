...
@Component({
  selector: 'app-mobile-account-page-type3-payments',
  templateUrl: './mobile-account-page-type3-payments.component.html',
  styleUrls: ['./mobile-account-page-type3-payments.component.scss']
})
export class MobileAccountPageType3PaymentsComponent extends AppCommonPaymentsComponent {
