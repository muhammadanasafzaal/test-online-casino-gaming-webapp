...
@Injectable()
export class BaseWithdrawType9Component extends BaseWithdrawPaymentComponent {
    ...
    ngOnInit() {
        ...
        this.paymentForm.addControl('CardHolderName', new FormControl('', [Validators.required]));
    ...
    ngOnDestroy() {
        ...
        this.paymentForm.removeControl('CardHolderName');
    }
